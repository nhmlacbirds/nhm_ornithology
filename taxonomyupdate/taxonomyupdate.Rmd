...
fulldata$genus_emu <- sub(" .*", "", fulldata$full_clements)
fulldata$species_clements <- sub(" [^ ]+$|^.*? ", "", fulldata$full_clements)
fulldata$species_clements <- sub(" .*", "", fulldata$species_clements)
...
# arrange by IOC_seq? aren't some missing? 
```
